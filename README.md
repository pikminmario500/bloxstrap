...
[![GitHub Workflow Status](https://img.shields.io/github/actions/workflow/status/pikminmario500/bloxstrap/ci.yml?branch=main&label=builds)](https://github.com/pikminmario500/bloxstrap/actions)
[![Downloads](https://img.shields.io/github/downloads/pikminmario500/bloxstrap/latest/total?color=981bfe)](https://github.com/pikminmario500/bloxstrap/releases)
[![Version](https://img.shields.io/github/v/release/pikminmario500/bloxstrap?color=7a39fb)](https://github.com/pikminmario500/bloxstrap/releases/latest)
...
[![lol](https://img.shields.io/badge/insert%20-funny%20gif-red)](https://c.tenor.com/BWpFVhAMzAoAAAAd/tenor.gif)
...
You will also need the [.NET 8 Desktop Runtime](https://aka.ms/dotnet-core-applaunch?missing_runtime=true&arch=x64&rid=win11-x64&apphost_version=8.0.6&gui=true). If you don't already have it installed, you'll be prompted to install it anyway. Be sure to install Bloxstrap after you've installed this.
