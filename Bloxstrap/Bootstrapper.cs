    ...
    public class Bootstrapper
    {
        ...
        public static void CheckInstall()
        {
            ...
            if (App.Settings.Prop.CreateDesktopIcon)
            {
                try
                {
                    ...
                    Utility.Shortcut.Create(Paths.Application, "-ide", Path.Combine(Paths.Desktop, $"Roblox Studio ({App.ProjectName}).lnk"));
        ...
        private void Uninstall()
        {
            ...
            var cleanupSequence = new List<Action>
            {
                ...
                () => File.Delete(Path.Combine(Paths.Desktop, $"Roblox Studio ({App.ProjectName}).lnk")),
