...
namespace Bloxstrap
{
    public class FastFlagManager : JsonManager<Dictionary<string, object>>
    {
        ...
        {
            { "Audio.VC", "DFFlagVoiceChat4 " },

            { "Rendering.Framerate1", "DFIntTaskSchedulerTargetFps" },
            { "Rendering.Framerate2", "FFlagTaskSchedulerLimitTargetFpsTo240" },
            ...
            { "Rendering.GraphicsQuality", "DFIntDebugFRMQualityLevelOverride" },
            { "Rendering.MovePrerender", "FFlagMovePrerender" },
            { "Rendering.GPULightCulling", "FFlagFastGPULightCulling3" },
            ...
            { "Rendering.Grass1", "FIntFRMMinGrassDistance" },
            { "Rendering.Grass2", "FIntFRMMaxGrassDistance" },
            { "Rendering.Grass3", "FIntRenderGrassDetailStrands" },
        ...
        {
            { GraphicsQuality.Default, null },
            { GraphicsQuality.Low, "1" },
            { GraphicsQuality.Medium, "10" },
            { GraphicsQuality.High, "21" },
        };
